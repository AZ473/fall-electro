...
import { LayoutDashboard, Package, ShoppingBag, Users, Tag, ArrowLeft, Zap, Award } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex bg-muted/30">
      <aside className="w-64 shrink-0 bg-card border-r border-border flex flex-col sticky top-0 h-screen">
        ...
        <Link to="/" className="m-3 flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground rounded-xl px-3 py-2 hover:bg-muted">
